...
class MetricsApi(object):
    ...
    def get_metrics(
        ...
        **kwargs
        ...
        """Get togai metrics.  # noqa: E501

        To get the metrics, you make a POST request to the /metrics resource. You can query up to five metrics in a single request. Single response dataset can contain a maximum of 100 data points.  # noqa: E501
        ...
        Keyword Args:
            get_metrics_request (GetMetricsRequest): [optional]
