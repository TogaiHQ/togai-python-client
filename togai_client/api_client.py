...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.add_aliases  # this is an instance of the class Endpoint
        api_instance.add_aliases()  # this invokes api_instance.add_aliases.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_aliases.callable or self.callable in this class
