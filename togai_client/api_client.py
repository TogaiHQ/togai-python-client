...
from togai_client import rest
from togai_client.configuration import Configuration
from togai_client.exceptions import ApiTypeError, ApiValueError, ApiException
from togai_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EventIngestionApi()
        api_instance.ingest  # this is an instance of the class Endpoint
        api_instance.ingest()  # this invokes api_instance.ingest.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.ingest.callable or self.callable in this class
