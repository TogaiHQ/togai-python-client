...
class Customer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, primary_email, billing_address, status, created_at, updated_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, primary_email, billing_address, status, created_at, updated_at, *args, **kwargs):  # noqa: E501
        """Customer - a model defined in OpenAPI
