...
def lazy_import():
    ...
    globals()['MetricQueryResponse'] = MetricQueryResponse


class GetMetricsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'results': ([MetricQueryResponse],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        """GetMetricsResponse - a model defined in OpenAPI

        Args:
            results ([MetricQueryResponse]):
