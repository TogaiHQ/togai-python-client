...
class CreateAccountRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, id, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            aliases ([str]): list of aliases for the account. Can be used interchangeably with 'id' for event ingestion.. [optional]  # noqa: E501
        """
