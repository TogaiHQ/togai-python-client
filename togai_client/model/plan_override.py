...
class PlanOverride(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, price_plan_name, start_date, end_date, *args, **kwargs):  # noqa: E501
        """PlanOverride - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, price_plan_name, start_date, end_date, *args, **kwargs):  # noqa: E501
        """PlanOverride - a model defined in OpenAPI
