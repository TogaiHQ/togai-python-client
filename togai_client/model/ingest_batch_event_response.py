...
def lazy_import():
    ...
    globals()['IngestError'] = IngestError


class IngestBatchEventResponse(ModelNormal):
    ...
    def _from_openapi_data(cls, errors, *args, **kwargs):  # noqa: E501
        """IngestBatchEventResponse - a model defined in OpenAPI
